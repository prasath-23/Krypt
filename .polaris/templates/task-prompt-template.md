...
lane: "planned"  # Edit directly or use: polaris agent tasks move-task <WPID> --to <lane>
...
The `polaris implement` command will display warnings when:
...
2. **Use CLI**: `polaris agent tasks move-task <WPID> --to <lane> --note "message"`
