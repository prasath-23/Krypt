        ...
        Column(
            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(stringResource(R.string.home_pairing_title), style = MaterialTheme.typography.titleMedium)
                    Text(
            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(stringResource(R.string.home_locked_title), style = MaterialTheme.typography.titleMedium)
                    Text(
